...
try {
    ...
    let loginOpts = {  //登入資訊
        host: config.address,  //伺服器ip
        port: config.port,  //伺服器port(預設25565)
        username: config.user,  //Minecraft帳號
        password: "-",  //Minecraft密碼
        auth: "mojang", //登入驗證器使用mojang或者microsoft
        defaultChatPatterns: false,
        authServer: `${this.authserver}/as`,
        sessionServer: `${this.authserver}/ss`,
    }
